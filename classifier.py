...
class Classifier(object):
    def __init__(self, bow):
        self.models = []       
        self.models.append(("naive_bayes", loadPickle('./models/naive_bayes/multinomial_bayes_bow_500')))        
        self.models.append(("svm", loadPickle('./models/svm/svm_3rdpolynomial_bow_500')))        
        self.models.append(("ann", loadPickle("./models/ann/ann_3layer_bow_500")))
        self.models.append(("softmax", loadPickle('./models/softmax/softmax_bow_500')))
